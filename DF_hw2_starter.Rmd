...
library(testthat)
library(assertthat)
load_all('/Users/dylan/HW2_632/HW2/')
```

```{r}
setwd('/Users/dylan/HW2_632/HW2/data')
...
```{r}
document("../HW2_632/HW2/R/")
```


```{r}
setwd('/Users/dylan/HW2_632/HW2/man/')
library(Rd2md)
as_markdown("plot_cp.Rd", outfile = "plot_cp.md")
```
...
https://github.com/fylandrank/HW2_632
